...
console.log(
  "双指针 [55,30,5,4,2],[100,20,10,10,5]:",
  maxDistance1855([55, 30, 5, 4, 2], [100, 20, 10, 10, 5]),
); // 2
console.log("双指针 [2,2,2],[10,10,1]:", maxDistance1855([2, 2, 2], [10, 10, 1])); // 1
console.log(
  "二分 [55,30,5,4,2],[100,20,10,10,5]:",
  maxDistance1855Binary([55, 30, 5, 4, 2], [100, 20, 10, 10, 5]),
); // 2
