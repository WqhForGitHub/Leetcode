...
// ============================================================
console.log("===== 132. 拼车 =====");
console.log("方法1:", carPooling([[2, 1, 5], [3, 3, 7]], 4)); // 期望: false
console.log("方法1:", carPooling([[2, 1, 5], [3, 3, 7]], 5)); // 期望: true
console.log("方法2:", carPooling2([[2, 1, 5], [3, 3, 7]], 4)); // 期望: false
console.log("方法2:", carPooling2([[2, 1, 5], [3, 3, 7]], 5)); // 期望: true
console.log("方法2:", carPooling2([[2, 1, 5], [3, 5, 7]], 3)); // 期望: true
console.log("方法2:", carPooling2([[3, 2, 7], [1, 3, 7], [2, 5, 8]], 6)); // 期望: true
