...
console.log("[[100,200],[200,1300],[1000,1250],[2000,3200]]:",
  scheduleCourse([[100, 200], [200, 1300], [1000, 1250], [2000, 3200]])); // 期望 3
console.log("[[1,2]]:", scheduleCourse([[1, 2]])); // 期望 1
console.log("[[3,2],[4,3]]:", scheduleCourse([[3, 2], [4, 3]])); // 期望 0
console.log("[[5,5],[4,6],[2,6]]:",
  scheduleCourse([[5, 5], [4, 6], [2, 6]])); // 期望 2
