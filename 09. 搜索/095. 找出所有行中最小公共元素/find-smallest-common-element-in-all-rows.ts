...
console.log("二分 [[1,2,3,4,5],[2,4,5,8,10],[3,5,7,9,11],[1,3,5,7,9]]:",
  smallestCommonElement([[1, 2, 3, 4, 5], [2, 4, 5, 8, 10], [3, 5, 7, 9, 11], [1, 3, 5, 7, 9]])); // 5
console.log("计数 [[1,2,3],[4,5,6],[7,8,9]]:",
  smallestCommonElementCount([[1, 2, 3], [4, 5, 6], [7, 8, 9]])); // -1
