...
console.log("DP [[1,2,4],[3,4,3],[2,3,1]],2:", maxValue([[1, 2, 4], [3, 4, 3], [2, 3, 1]], 2)); // 7
console.log("DP [[1,2,4],[3,4,3],[2,3,10]],2:", maxValue([[1, 2, 4], [3, 4, 3], [2, 3, 10]], 2)); // 10
console.log("记忆化 [[1,1,1],[2,2,2],[3,3,3],[4,4,4]],3:", maxValueMemo([[1, 1, 1], [2, 2, 2], [3, 3, 3], [4, 4, 4]], 3)); // 9
