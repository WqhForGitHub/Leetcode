...
console.log("堆 [[1,4],[2,4],[3,6],[4,4]],[2,3,4,5]:",
  minInterval([[1, 4], [2, 4], [3, 6], [4, 4]], [2, 3, 4, 5])); // [3,3,1,4]
console.log("堆 [[2,3],[2,5],[1,8],[20,25]],[2,19,5,22]:",
  minInterval([[2, 3], [2, 5], [1, 8], [20, 25]], [2, 19, 5, 22])); // [2,-1,4,6]
